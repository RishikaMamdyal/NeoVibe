      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400">Shaping the future of virtual reality experiences.</p>
          </div>
          <div>
          ...
          <div>
            ...
            <form className="flex">
              ...
              <button
                type="submit"
                className="bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-r-full transition-colors duration-300"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center">
          <p className="text-gray-400">&copy; 2025 NeoVibe. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
